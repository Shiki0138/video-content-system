...
現在のVideoAI Studioは、自動的な画像生成ではなく、**DALL-E 3/ChatGPT用の高品質プロンプトを生成する方式**に変更されました。これにより、コストを削減し、柔軟性を高め、品質管理を向上させています。

詳細は[IMAGE_PROMPT_GENERATION.md](IMAGE_PROMPT_GENERATION.md)をご覧ください。
